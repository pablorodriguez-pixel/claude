...
|---|---|
| 6 UCQ + 9 localizadas | infeasible |
...
La localizada que suelta María va a **Ana G.** y no a Sandra: Ana G. acumulaba 32 desde junio
frente a las 33 de Sandra, y así el acumulado queda mejor repartido (solo Isabel llega a 40).
...
1. ~~Eva coge la UCQ del 13 y el 15~~ → **deshecho.** Vuelven a ser de Ana, y Eva sigue sin
   ningún día de unidad. Las dos UCQ de Ana van emparejadas (el 13 y el 15 son el mismo
   equipo), así que no se puede pasar solo una: o se mueven las dos o ninguna.
2. ~~Miriam coge el sábado 28~~ → **deshecho.** Miriam vuelve al 10, 16 y 19, sin ningún
   finde dentro del 3-30; su único finde es el día 2. Con eso vuelven también los días 10,
   26 y 28 a como estaban.
3. **El contaje de findes incluye el 1 y el 2** → **se mantiene.** Es el puente del 31 de
   octubre. Criterio de contaje, que es el de la lista manual del usuario:
...
El cuadrante vuelve a ser exactamente el de la v18/v19. `check.py` da **0 errores** y las
mismas 3 normas saltadas a propósito.
